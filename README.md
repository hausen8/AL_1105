...
- AL1105_postgui.hal contains all connections to input devices like the pendand (Logitech F310 USB game controller), buttons and LEDs in a keyboard drawer and the PyVCP panel
